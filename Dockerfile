...
# jboss/base-jdk:8 extends from jboss/base:latest
# jboss/base:latest extends from centos:7
# Merged all other Dockerfiles into one.

# FROM centos:7

# centos:7 does not (yet) have a package for openjdk-11. Using latest ubuntu
